<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos/Principal/global.Master" AutoEventWireup="true" CodeBehind="Corso_Mantenimiento_Usuarios.aspx.cs" Inherits="Proyecto5A_CCGM.Mantenimientos.Principal.Corso_Mantenimiento_Usuarios" %>
            ...
            <div class="col-12 mt-4">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <span class="float-left">Porfavor ingresa el nombre o ID del usuario que deseas administrar.
                        </span>
                         <div class="customize-input col-md-4">
                                        ...
                                        <div class="form-body">
                                           ...
                                           <asp:Label ID="Label1" runat="server" Text="Domicilio"></asp:Label>
                                            ...
                                            <div class="text-center">
                                                <asp:Button ID="btn_guardar" CssClass="btn btn-info" runat="server" Text="Guardar" />
                                            <asp:Button ID="Button1" CssClass="btn btn-danger" runat="server" Text="Editar" />
                                                <asp:Button ID="Button2" CssClass="btn btn-success" runat="server" Text="Eliminar" />
                                            </div>
                                        </div>
                                        </div>
